          ...
          '/cn/adopt/': [
            {
              ...
              items: [
                ...
                { text: '---', type: 'separator' },
                { text: '🚀 快速上手', type: 'separator' },
                { text: '第 1 章 快速开始', link: '/cn/adopt/chapter1' },
                { text: '第 2 章 命令行与配置', link: '/cn/adopt/chapter2' },
                { text: '第 3 章 渠道接入', link: '/cn/adopt/chapter3' },
                { text: '第 4 章 技能系统', link: '/cn/adopt/chapter4' },
                { text: '---', type: 'separator' },
                { text: '🎯 进阶实战', type: 'separator' },
          ...
          '/cn/appendix/': [
            {
              ...
              items: [
                ...
                { text: '应用场景', link: '/cn/appendix/use-cases' },
              ]
            }
          ],
          '/cn/build/': [
            {
              ...
              items: [
                ...
                { text: '---', type: 'separator' },
                { text: '📌 第一板块：OpenClaw 内部拆解', type: 'separator' },
                { text: '第 1 章 核心架构', link: '/cn/build/chapter1' },
                { text: '第 2 章 提示词系统', link: '/cn/build/chapter2' },
                { text: '第 3 章 工具系统', link: '/cn/build/chapter3' },
                { text: '第 4 章 渠道开发', link: '/cn/build/chapter4' },
                { text: '第 5 章 技能开发', link: '/cn/build/chapter5' },
                { text: '第 6 章 安全加固', link: '/cn/build/chapter6' },
                { text: '---', type: 'separator' },
                { text: '📌 第二板块：已有案例分析', type: 'separator' },
                ...
                { text: '---', type: 'separator' },
                { text: '📌 第三板块：定制你的 Claw', type: 'separator' },
